<template>
  <div class="flex flex-col justify-center md:px-48 py-8">
        <div class="w-full">
            <div class="pt-8 flex justify-center tracking-wider leading-loose">
                <div class="mb-8 text-center">
                    <div class="text-4xl font-bold text-center">What Are <span class="text-codeacademy">Saying</span> Our Client</div>
        ...
        <div class="w-full flex">
            <div class=""><!-- ====== Testimonials Section Start -->
                <section class=" lg:pt-[120px] pb-20 lg:pb-[120px]">
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="w-full md:flex items-center">
                                        ...
                                        >
                                        <img
                                            src="https://thumbs.dreamstime.com/b/beautiful-business-lady-reading-5986604.jpg"
                                            alt="image"
                                            class="w-full"
                                            />
                                        <span
                                        ...
                                        <div class="w-full">
                                        <div>
                                            <div class="mb-8 absolute top-2 left-2">
                                                <img class="h-20"
