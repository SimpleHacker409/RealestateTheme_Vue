<template>
  <div class="md:px-32 xl:px-48">
        <div class="px-10">
            <div class="pt-8 flex tracking-wider leading-loose">
                <div class="mb-8">
                    <div class="text-4xl font-bold">Our Most Popular Trading</div>
                     <span class="text-4xl font-bold text-codeacademy">Property</span>
                    <p class="text-gray-600 max-w-lg">Lorem ipsum impression it would make. An agency, in broad terms, is any relationship between two parties in which.</p>
                </div>
            </div>
        </div>

      <carousel :autoplay="true" :margin="100" :autoplayHoverPause="false" :responsive="{1200:{items:3},800:{items:2},500:{items:1}}" class="px-10">
            ...
            <div class="relative mx-auto w-full">
                ...
                <div class="shadow p-4 rounded-xl bg-white">
                    ...
                    <span class="absolute top-0 left-0 inline-flex mt-5 ml-5 px-3 py-1 rounded-lg z-10 bg-blue-100 text-sm font-medium text-codeacademy select-none">
                        Available Now
                    </span>
