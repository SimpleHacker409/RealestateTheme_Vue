<template>
  <div class="lg:px-56 pb-10">
        <div class="pt-8 flex justify-center tracking-wider leading-loose">
            <div class="mb-8 text-center">
                <div class="text-4xl font-bold text-center">Recent Added <span class="text-codeacademy">Trading</span> Propertys</div>
                <p class="text-gray-600 max-w-lg">The better impression it would make. An agency, in broad terms, is any relationship between two parties in which.</p>
            </div>
        </div>

       
        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-16 w-full">
            <div class="relative mx-auto w-full">
                ...
                <div class="shadow p-4 rounded-xl bg-white">
                    ...
                    <div class="mt-4">
                    <div class="flex justify-between text-codeacademy">
                        <div class="justify-start">
                        <p class="inline-block font-semibold text-2xl whitespace-nowrap leading-tight rounded-xl">
                        <span class="text-lg uppercase">
                            $
                        </span>
                        <span class="text-xl">253,200</span>
                        </p>
                        </div>
                        <div class=" justify-end">
                             <svg class="animate-ping inline-block w-6 h-6 xl:w-6 xl:h-5 mr-3 fill-current text-gray-800" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M462.3 62.6C407.5 15.9 326 24.3 275.7 76.2L256 96.5l-19.7-20.3C186.1 24.3 104.5 15.9 49.7 62.6c-62.8 53.6-66.1 149.8-9.9 207.9l193.5 199.8c12.5 12.9 32.8 12.9 45.3 0l193.5-199.8c56.3-58.1 53-154.3-9.8-207.9z"></path></svg>
                             <svg class="inline-block w-6 h-6 xl:w-6 xl:h-5 mr-3 fill-current text-gray-800" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M448 127.1C448 181 405 223.1 352 223.1C326.1 223.1 302.6 213.8 285.4 197.1L191.3 244.1C191.8 248 191.1 251.1 191.1 256C191.1 260 191.8 263.1 191.3 267.9L285.4 314.9C302.6 298.2 326.1 288 352 288C405 288 448 330.1 448 384C448 437 405 480 352 480C298.1 480 256 437 256 384C256 379.1 256.2 376 256.7 372.1L162.6 325.1C145.4 341.8 121.9 352 96 352C42.98 352 0 309 0 256C0 202.1 42.98 160 96 160C121.9 160 145.4 170.2 162.6 186.9L256.7 139.9C256.2 135.1 256 132 256 128C256 74.98 298.1 32 352 32C405 32 448 74.98 448 128L448 127.1zM95.1 287.1C113.7 287.1 127.1 273.7 127.1 255.1C127.1 238.3 113.7 223.1 95.1 223.1C78.33 223.1 63.1 238.3 63.1 255.1C63.1 273.7 78.33 287.1 95.1 287.1zM352 95.1C334.3 95.1 320 110.3 320 127.1C320 145.7 334.3 159.1 352 159.1C369.7 159.1 384 145.7 384 127.1C384 110.3 369.7 95.1 352 95.1zM352 416C369.7 416 384 401.7 384 384C384 366.3 369.7 352 352 352C334.3 352 320 366.3 320 384C320 401.7 334.3 416 352 416z"></path></svg>
                        </div>
                    </div>
                    <h2 class="font-medium pt-3 tracking-wide text-sm md:text-base text-gray-800 line-clamp-1" title="New York">
                        The better imprression it would make an agency
                    </h2>
                    ...
                    <div class="flex  space-x-8 py-4">
                        ...
                        <p class="flex items-center font-medium text-gray-800">
                            <svg class="w-5 h-5 fill-current mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 480 512"><path d="M0 32h214.6v214.6H0V32zm233.4 0H448v214.6H233.4V32zM0 265.4h214.6V480H0V265.4zm233.4 0H448V480H233.4V265.4z"></path></svg>
                            2
                        </p>
            ...
            <div class="relative mx-auto w-full">
                ...
                <div class="shadow p-4 rounded-xl bg-white">
                    ...
                    <div class="flex justify-between text-codeacademy">
                        <div class="justify-start">
                        <p class="inline-block font-semibold text-xl whitespace-nowrap leading-tight rounded-xl">
                        <span class="text-lg uppercase">
                            $
                        </span>
                        <span class="text-xl">253,200</span>
                        ...
                        <div class=" justify-end">
                             <svg class="inline-block w-6 h-6 xl:w-6 xl:h-5 mr-3 fill-current text-gray-800" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M462.3 62.6C407.5 15.9 326 24.3 275.7 76.2L256 96.5l-19.7-20.3C186.1 24.3 104.5 15.9 49.7 62.6c-62.8 53.6-66.1 149.8-9.9 207.9l193.5 199.8c12.5 12.9 32.8 12.9 45.3 0l193.5-199.8c56.3-58.1 53-154.3-9.8-207.9z"></path></svg>
                             <svg class="inline-block w-6 h-6 xl:w-6 xl:h-5 mr-3 fill-current text-gray-800" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M448 127.1C448 181 405 223.1 352 223.1C326.1 223.1 302.6 213.8 285.4 197.1L191.3 244.1C191.8 248 191.1 251.1 191.1 256C191.1 260 191.8 263.1 191.3 267.9L285.4 314.9C302.6 298.2 326.1 288 352 288C405 288 448 330.1 448 384C448 437 405 480 352 480C298.1 480 256 437 256 384C256 379.1 256.2 376 256.7 372.1L162.6 325.1C145.4 341.8 121.9 352 96 352C42.98 352 0 309 0 256C0 202.1 42.98 160 96 160C121.9 160 145.4 170.2 162.6 186.9L256.7 139.9C256.2 135.1 256 132 256 128C256 74.98 298.1 32 352 32C405 32 448 74.98 448 128L448 127.1zM95.1 287.1C113.7 287.1 127.1 273.7 127.1 255.1C127.1 238.3 113.7 223.1 95.1 223.1C78.33 223.1 63.1 238.3 63.1 255.1C63.1 273.7 78.33 287.1 95.1 287.1zM352 95.1C334.3 95.1 320 110.3 320 127.1C320 145.7 334.3 159.1 352 159.1C369.7 159.1 384 145.7 384 127.1C384 110.3 369.7 95.1 352 95.1zM352 416C369.7 416 384 401.7 384 384C384 366.3 369.7 352 352 352C334.3 352 320 366.3 320 384C320 401.7 334.3 416 352 416z"></path></svg>
                        </div>
                    </div>
                    <h2 class="font-medium pt-3 tracking-wide text-sm md:text-base text-gray-800 line-clamp-1" title="New York">
            ...
            <div class="flex h-1 justify-center py-8">
            <button class="flex justify-center items-center h-12 px-6 w-auto focus:outline-none bg-codeacademy text-white hover:shadow-xl transition-shadow duration-300">Learn More</button>
            </div>
  </div>
</template>
